...
# AFTER THE CODE COMPLETED TAKE TERMINAL AND INPUT THE **streamlit run fraud_detection.py** AND ENTER THE BUTTON
# IF THE THE #pip install streamlit IS NOT INSTALL INSTALL FIRST
